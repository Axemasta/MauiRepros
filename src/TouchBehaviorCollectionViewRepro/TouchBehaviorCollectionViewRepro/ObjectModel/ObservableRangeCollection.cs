...
namespace TouchBehaviorCollectionViewRepro.ObjectModel;
...
public class ObservableRangeCollection<T> : ObservableCollection<T>
{
	...
	/// T). NOTE: with notificationMode = Remove, removed items starting index is not set because items are
	/// not guaranteed to be consecutive.
	/// </summary>
