...
[![Maui Issue Status](https://img.shields.io/github/issues/detail/state/dotnet/maui/todo)](https://github.com/dotnet/maui/issues/todo)
...
<video src="/Users/alex.duffell/Documents/Dev/Github/Axemasta/MauiRepros/src/TranslateToNet10/assets/net9_working_example.mov" controls=""></video>

As you can see pressing the "Show Footer" button causes the `FooterView` to animate on/off screen. All buttons remain responsive and nothing crashes.

### NET 10

Flip the project to NET10 and the moment you try animating the view, it freezes:

<video src="/Users/alex.duffell/Documents/Dev/Github/Axemasta/MauiRepros/src/TranslateToNet10/assets/net10_deadlock_example.mov" controls=""></video>
